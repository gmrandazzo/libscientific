...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/include/scientific/scientificinfo.h;/usr/local/include/scientific/vector.h;/usr/local/include/scientific/matrix.h;/usr/local/include/scientific/array.h;/usr/local/include/scientific/numeric.h;/usr/local/include/scientific/graphs.h;/usr/local/include/scientific/algebra.h;/usr/local/include/scientific/statistic.h;/usr/local/include/scientific/metricspace.h;/usr/local/include/scientific/pca.h;/usr/local/include/scientific/pls.h;/usr/local/include/scientific/upca.h;/usr/local/include/scientific/upls.h;/usr/local/include/scientific/lda.h;/usr/local/include/scientific/clustering.h;/usr/local/include/scientific/mlr.h")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
